...
- change_event_color — изменить цвет существующего события на КОНКРЕТНЫЙ цвет: "отметь встречу красным", "пометь обед синим", "покрась ртутный кек жёлтым". Используй title=название (или null если не указано), color_id=цвет. НЕ используй этот intent для "сделано/выполнено/готово" без указания цвета.
- mark_event_done — отметить событие как выполненное/сделанное: "пометь как сделано", "отметь выполненным", "закрой задачу", "сделано", "готово". title=название события (null если не указано).
...
- setup_colors — настроить/поменять цвета или статусы цветов: "настрой цвета", "поменяй цвета", "что означают цвета", "мои цвета", "/colors", "сделано - зеленый", "выполнено это синий", "красный - срочное, зеленый - сделано". Используй этот intent когда пользователь назначает смысл/лейбл цвету.
