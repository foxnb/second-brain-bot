...
set_item_status — поставить статус элементу списка: "полить цветы — в работе", "встреча сделана"; title=элемент, status=статус текстом, list_name=список (или null)
...
- defer → "Хорошо! Напиши мне когда будешь готова — всё сделаем 😊"
